...
`45-how-many-laps-fit-in-the-limit.ts` 是第一个：它量「`RECURSION_LIMIT = 48` 等于几圈」，
而 ADR 0009 把步数预算整个删了，那个常数今天是 `1_000_000` 的格式占位。
